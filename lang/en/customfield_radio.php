...
/**
 * Customfield radio plugin strings
 *
...
$string['menuoptions'] = 'Radio options (one per line)';
$string['pluginname'] = 'Radio';
$string['privacy:metadata'] = 'The Radio field type plugin doesn\'t store any personal data; it uses tables defined in core.';
$string['specificsettings'] = 'Radio field settings';
